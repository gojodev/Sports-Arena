(() => {
  ...
  userInput.addEventListener("input", () => {
    ...
    results.forEach((result) => {
      ...
      div.textContent = "".concat(club.name, " \nSport: ").concat(club.sport, " \nTrainer: ").concat(club.trainer, " \nCalorie Burn Rate: ").concat(club.caloryBurnRate, "cal/hr");
